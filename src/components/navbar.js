        ...
        <div className="w-full flex items-center justify-between mt-0 px-6 py-2">
          ...
          <div className="order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4" id="nav-content">
            <div className="auth flex items-center w-full md:w-full">
              <button className="bg-transparent text-gray-800  p-2 rounded border border-gray-300 mr-4 hover:bg-gray-100 hover:text-gray-700"><Link to="/seller/login">Sign in</Link></button>
              <button className="bg-blue-600 text-gray-200  p-2 rounded  hover:bg-blue-500 hover:text-gray-100"><Link to="/seller/signup">Sign up</Link></button>
            </div>
          </div>
        </div>
      </nav>
